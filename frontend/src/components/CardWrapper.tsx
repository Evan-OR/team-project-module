    ...
    <div className={styles.cardDisplayWrapper}>
      <div className={styles.cardWrapper}>
        ...
        <div className={styles.text}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec non turpis finibus, viverra lacus sit amet,
          feugiat leo. Duis eu sagittis neque. Suspendisse ut nunc quam.{' '}
        </div>
      </div>
